...
import SinergiaConfigAdminFinal from "./app/pages/SinergiaConfigAdminFinal"; // 🎛️ SINERGIA CONFIG ADMIN
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/app" element={
            ...
            <Route path="sinergia-config-admin" element={<SinergiaConfigAdminFinal />} />
