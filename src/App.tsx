...
import SinergiaConfigAdminUltra from "./app/pages/SinergiaConfigAdminUltra"; // 🎛️ SINERGIA CONFIG ADMIN
...
import OportunidadesTrabalhoAdmin from "./app/pages/OportunidadesTrabalhoAdmin"; // ✨ OPORTUNIDADES ADMIN
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/app" element={
            ...
            <Route path="sinergia-config-admin" element={<SinergiaConfigAdminUltra />} />
            ...
            <Route path="oportunidades-trabalho-admin" element={<OportunidadesTrabalhoAdmin />} />
          </Route>
